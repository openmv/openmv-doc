...
.. class:: WLAN(interface_id: int) -> None
   ...
   .. method:: connect(ssid: Optional[str] = None, key: Optional[str] = None, *, bssid: Optional[bytes] = None) -> None
   ...
   .. method:: scan() -> List[Tuple[bytes, bytes, int, int, int, int]]
