...
.. class:: CAN(id: int, *args, **kwargs)
   ...
   .. method:: init(bitrate: int, mode: int = CAN.MODE_NORMAL, sample_point: int = 75, sjw: int = 1, tseg1: int | None = None, tseg2: int | None = None) -> None
   ...
   .. method:: set_filters(filters: list | tuple | None) -> None
   ...
   .. method:: send(id: int, data: bytes, flags: int = 0) -> int | None
   ...
   .. method:: recv(arg: list | None = None) -> list | None
   ...
   .. method:: irq(handler: Callable[[CAN], None] | None = None, trigger: int = 0, hard: bool = False) -> None
   ...
   .. method:: cancel_send(index: int) -> bool
   ...
   .. method:: get_counters(list: list | None = None, /) -> list
   ...
   .. method:: get_timings(list: list | None = None, /) -> list
