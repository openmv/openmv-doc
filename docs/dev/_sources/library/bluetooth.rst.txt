...
.. note:: For most applications, we recommend using the higher-level
          :mod:`aioble` library which provides an asyncio-based wrapper
          around this module. See :doc:`aioble`.
...
.. class:: BLE()
    ...
    .. method:: gatts_register_services(services_definition: Sequence[Tuple], /) -> Tuple[Tuple[int, ...], ...]
