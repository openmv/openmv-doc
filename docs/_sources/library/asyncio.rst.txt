...
.. function:: create_task(coro: Coroutine) -> Task
...
.. function:: sleep(t: float) -> None

    Sleep for *t* seconds (can be a float).

    This is a coroutine.

.. function:: sleep_ms(t: int) -> None
...
.. function:: wait_for(awaitable: Awaitable, timeout: float) -> Any
...
.. function:: gather(*awaitables, return_exceptions: bool = False) -> List
...
.. function:: start_server(callback: Callable, host: str, port: int, backlog: int = 5, ssl: ssl.SSLContext | None = None) -> Server
...
.. class:: Stream()
    ...
    .. method:: get_extra_info(v: str) -> Any
    ...
    .. method:: wait_closed() -> None

       Wait for the stream to close.

       This is a coroutine.

    .. method:: read(n: int = -1) -> bytes
    ...
    .. method:: readinto(buf: bytearray | memoryview) -> int
    ...
    .. method:: readexactly(n: int) -> bytes
...
.. class:: Loop()
    ...
    .. method:: set_exception_handler(handler: Callable) -> None

       Set the exception handler to call when a Task raises an exception that is not
       caught.  The *handler* should accept two arguments: ``(loop, context)``.

    .. method:: get_exception_handler() -> Optional[Callable]

       Get the current exception handler.  Returns the handler, or ``None`` if no
       custom handler is set.

    .. method:: default_exception_handler(context: dict) -> None

       The default exception handler that is called.

    .. method:: call_exception_handler(context: dict) -> None
