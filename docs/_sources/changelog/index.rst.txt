...
Each OpenMV product keeps its own release history. Pick the one you're
interested in — every entry describes what's new, what changed, and (where it
matters) exactly how to migrate.
...
.. raw:: html
   ...
   <div class="changelog-products">
     <a class="changelog-product-card icon-green" href="firmware/index.html">
       ...
       <p>The MicroPython machine-vision firmware that runs on the OpenMV
       Cam. New camera, image-processing, and board-support features, plus
       breaking API changes and migration steps for your scripts.</p>
     ...
     <a class="changelog-product-card icon-purple" href="openmv-py/index.html">
       ...
       <p>The host-side Python library and <code>openmv</code> command-line
       tool for talking to an OpenMV Cam from your computer over the Camera
       Protocol V2 — streaming, scripting, and benchmarking.</p>
       <span class="card-arrow">View releases →</span>
     </a>
     <a class="changelog-product-card icon-amber" href="arduino-rpc/index.html">
       ...
       <p>The Arduino library for controlling an OpenMV Cam over CAN, I²C,
       SPI, UART, and USB. New board support, bus interfaces, and
       reliability fixes.</p>
       <span class="card-arrow">View releases →</span>
     </a>
   </div>
