...
class Lora:
    ...
    uart – Pre-configured machine.UART instance used to talk
    to the modem. If None, the driver opens UART(8, 19200) with 8N2
    framing (the Portenta Vision Shield default).

    rst_pin – machine.Pin driving the modem’s reset line. If
    None, "PC6" is configured as a push-pull output.

    boot_pin – machine.Pin driving the modem’s boot-select
