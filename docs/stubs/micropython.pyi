...
def kbd_intr(chr: int) -> None:
    ...
    """
    ...
def mem_info(verbose: Any | None = None) -> None:
    """
    ...
    """
    ...
def opt_level(level: int | None = None) -> Optional[int]:
    """
    ...
    """
    ...
def qstr_info(verbose: Any | None = None) -> None:
    """
...
class RingIO:
    ...
    def readinto(self, buf: bytearray | memoryview, nbytes: int | None = None) -> int:
        ...
        """
        ...
    def readline(self, nbytes: int | None = None) -> bytes:
        """
