...
class ADCBlock:
    ...
    @overload
    def connect(self, channel: int, *, sample_ns: int | None = None, atten: int | None = None) -> ADC:
        ...
    @overload
    def connect(self, source: Pin, *, sample_ns: int | None = None, atten: int | None = None) -> 'ADC':
        ...
    @overload
