...
class BLE:
    ...
    def gatts_read(self, value_handle: int, /) -> bytes:
        ...
        """
        ...
    def gatts_register_services(self, services_definition: Sequence[Tuple], /) -> Tuple[Tuple[int, ...], ...]:
        """
    ...
    def irq(self, handler: Callable[[int, Tuple], Any | None], /) -> None:
        ...
        bluetooth module. Add the ones that you need from the list above to your
        program.
        """
        ...
