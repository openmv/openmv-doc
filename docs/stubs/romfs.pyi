...
"""
The romfs module provides helper utilities for inspecting the
read-only filesystem (ROMFS) that the OpenMV firmware mounts at
/rom. See romfs for an end-to-end description of the ROMFS
filesystem itself, how images are built and deployed, and the
underlying vfs.VfsRom / vfs.rom_ioctl() APIs.
...
references. ls_romfs() reports the address, size and largest
