...
* Transcend 1GB SD (handles 96KB bursts, but very slow constant throughput 6KB/s!)
...
Note, there will be a significant slow down as the number of files in one
directory increases. We suggest using a set of directories to load balance the
data storage if speed is required.
